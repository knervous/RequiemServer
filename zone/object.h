...
#ifdef SWIG_VERSION
	constexpr uint32 ObjectType_Quest     = 13;
#else
...
#ifdef SWIG_VERSION
	constexpr uint32 ObjectType_TradeskillBag = 58;
#else
...
#ifdef SWIG_VERSION
	{ ObjectType::ObjectType_Quest,      "Quest" },
#else
...
#ifdef SWIG_VERSION
	{ ObjectType::ObjectType_TradeskillBag, "Tradeskill Bag" },
#else
