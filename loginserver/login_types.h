...
struct LoginWorldServer_Struct
{
	char *ip;
...
struct LoginServerResponse_Struct
{
	struct LoginBaseMessage_Struct base;
    struct LoginBaseReplyMessage_Struct reply;

	int32_t server_count;
	struct LoginWorldServer_Struct servers[];
};
