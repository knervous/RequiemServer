...
int16 Web::invtype::GetInvTypeSize(int16 inv_type)
{
	switch (inv_type) {
...
const char* Web::invtype::GetInvTypeName(int16 inv_type)
{
	switch (inv_type) {
...
bool Web::invtype::IsInvTypePersistent(int16 inv_type)
{
	switch (inv_type) {
	case invtype::typePossessions:
	case invtype::typeBank:
...
const char* Web::invslot::GetInvPossessionsSlotName(int16 inv_slot)
{
	switch (inv_slot) {
...
const char* Web::invslot::GetInvCorpseSlotName(int16 inv_slot)
{
...
const char* Web::invslot::GetInvSlotName(int16 inv_type, int16 inv_slot)
{
...
const char* Web::invbag::GetInvBagIndexName(int16 bag_index)
{
...
const char* Web::invaug::GetInvAugIndexName(int16 aug_index)
{
